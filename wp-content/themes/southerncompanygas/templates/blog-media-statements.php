...
if ( is_search() ) {
	...
	$display_featured_images = 0;
	$grid_columns            = 1;
	$grid_columns_spacing    = '40px';
	$is_there_meta_above     = false;
	$is_there_meta_below     = Avada()->settings->get( 'post_meta' ) && true;
		...
		<?php while ( have_posts() ) : ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( $post_classes ); ?>>
				...
				<div class="fusion-post-content post-content">
					<?php echo avada_render_post_title( $post->ID, true, '', '3' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>
					...
					<div class="fusion-post-content-container">
						...
						echo fusion_get_post_content_excerpt( 55, true, $post->ID );
						?>
					</div>
				</div>
						...
						<div class="fusion-meta-info">
							...
							<?php if ( 'large' === $blog_layout || 'medium' === $blog_layout ) : ?>
								<?php
									...
									echo fusion_render_post_metadata( 'standard', $settings ); // phpcs:ignore WordPress.Security.EscapeOutput
								?>
							<?php endif; ?>
