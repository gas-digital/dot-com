...
class FusionBuilder {
	...
	public function set_body_classes() {
		...
		$classes[] = 'fusion-button_shape-' . strtolower( fusion_get_option( 'button_shape' ) );
	...
	public static function set_element_description_map() {
		...
		$element_option_map['shape']['fusion_button']                              = [
		...
		$element_option_map['button_shape']['fusion_tagline_box']       = [
			'theme-option' => 'button_shape',
			'type'         => 'select',
		];
		...
		$element_option_map['icons_boxed_radius']['fusion_sharing'] = [ 'theme-option' => 'social_links_boxed_radius' ];
		...
		$element_option_map['icon_colors']['fusion_sharing']        = [ 'theme-option' => 'social_links_icon_color' ];
		$element_option_map['box_colors']['fusion_sharing']         = [ 'theme-option' => 'social_links_box_color' ];
